<template>
	<nav class="site-nav">
		<ul class="site-nav__list">
			...
			>
				<a v-if="item.url.includes('#')" ref="nav-link" class="site-nav__link" :href="item.url"
				> {{ item.label }} </a>
				<router-link v-else class="site-nav__link" ref="nav-link" :to=item.url>{{ item.label }}</router-link>

<template>
	<section class="banner">
		<picture v-if="data.image" class="banner__image">
			<source v-if="data.image.sourceUrlDesk" media="(min-width: 1200px)" :srcset="data.image.sourceUrlDesk">
		...
		<b-container>
			<div class="banner__caption">
				...
				<h1 v-if="data.title" class="banner__caption-title" v-html="data.title"></h1>
				<p v-if="data.text" class="banner__caption-text" v-html="data.text"></p>

				<span
					v-if="data.scrollTo.id"
					class="banner__btn btn"
					@click="e => clickItem(e, `#${data.scrollTo.id}`)"
				>{{ data.scrollTo.button }}
				</span>
